...
INSERT INTO `book_image` VALUES (2,'소록-999','가짜이름2.png','진짜이름2.png'),(3,'소록-999','가짜이름3.png','진짜이름3.png'),(4,'소록-999','가짜이름4.png','진짜이름4.png'),(5,'소록-999','가짜이름1.png','진짜이름1.png'),(6,'소록-999','가짜이름2.png','진짜이름2.png'),(7,'소록-999','가짜이름3.png','진짜이름3.png'),(8,'소록-999','가짜이름4.png','진짜이름4.png'),(9,'소록-999','가짜이름1.png','진짜이름1.png'),(10,'소록-999','가짜이름2.png','진짜이름2.png'),(11,'소록-999','가짜이름3.png','진짜이름3.png'),(12,'소록-999','가짜이름4.png','진짜이름4.png'),(13,'소록-999','가짜이름1.png','진짜이름1.png'),(14,'소록-999','가짜이름2.png','진짜이름2.png'),(15,'소록-999','가짜이름3.png','진짜이름3.png'),(16,'소록-999','가짜이름4.png','진짜이름4.png'),(18,'소록-999','f651a8fce94d49e98e99f799f1e1ef1f.jpg','7KSA67KF7J206647KeA67OA6rK9.jpg'),(19,'소록-999','69119565670f4482925e2be3eea57fa3.jpg','테스트2.jpg');
...
INSERT INTO `book_like` VALUES (1,1,'1'),(2,1,'2'),(3,2,'1'),(4,3,'1'),(5,4,'1');
...
INSERT INTO `rental_dtl` VALUES (1,1,471,NULL),(2,1,472,NULL),(3,1,473,NULL),(4,1,471,NULL),(5,1,472,NULL),(6,1,473,NULL),(7,1,470,NULL),(8,1,469,NULL),(9,1,468,NULL),(10,1,460,'2023-01-19');
...
INSERT INTO `rental_mst` VALUES (1,1,'2023-01-19','2023-02-02');
...
INSERT INTO `role_dtl` VALUES (1,1,1,'2023-01-10 20:44:20','2023-01-10 20:44:20');
...
INSERT INTO `role_mst` VALUES (1,'ROLE_USER','2023-01-05 20:51:47','2023-01-05 20:51:47'),(2,'ROLE_ADMIN','2023-01-05 20:51:47','2023-01-05 20:51:47');
...
INSERT INTO `user_mst` VALUES (1,'aaa','$2a$10$/lfuET2PcwoC8Ii9YV6oDupt1KpJEk6G7OxgSyKmRcP610oCfNGWm','김준일','abc@gmail.com','2023-01-10 20:44:20','2023-01-10 20:44:20');
...
/*!50001 VIEW `category_view` AS select row_number() OVER (ORDER BY `book_mst`.`category` )  AS `id`,`book_mst`.`category` AS `category` from `book_mst` group by `book_mst`.`category` */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `test` AS select `user_mst`.`username` AS `username`,`user_mst`.`name` AS `name` from `user_mst` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-01-19 21:50:41
